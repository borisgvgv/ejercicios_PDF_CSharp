...
class Program
{
    static void Main()
    {
        ...
        // Solicitar al usuario ingresar 5 datos numéricos enteros
        for (int i = 0; i < arrayDatos.Length; i++)
        {
        ...
        // Solicitar al usuario un nuevo dato
        Console.Write("Ingrese un nuevo dato: ");
        int nuevoDato = Convert.ToInt32(Console.ReadLine());

        // Encontrar el valor más cercano, mayor que el nuevo dato
        int valorMasCercanoMayor = EncontrarMasCercanoMayor(arrayDatos, nuevoDato);

        // Mostrar el resultado
        if (valorMasCercanoMayor != int.MaxValue)
        {
            Console.WriteLine($"El valor más cercano y mayor que {nuevoDato} es: {valorMasCercanoMayor}");
        }
        else
        {
            Console.WriteLine("Ninguno de los valores es mayor que el nuevo dato.");
        }
    }

    static int EncontrarMasCercanoMayor(int[] array, int nuevoDato)
    {
        int distanciaMinima = int.MaxValue;
        int valorMasCercanoMayor = int.MaxValue;
