                ...
                case 1:
                    ...
                    if (contador == 0)
                    {
                        ...
                        using (StreamWriter fichero = new StreamWriter("fichero.txt"))
                        {
                            ...
                            double tamanyo = Convert.ToDouble(Console.ReadLine());
                            fichero.WriteLine($"Nombre: {nombre}, Tamaño: {tamanyo}");
                        }
                        if (contador == 0)
                            contador++;
                    }
                    ...
                    using (StreamReader fichero = new StreamReader("fichero.txt"))
                    {
                        ...
                        do
                        {
                            ...
                            if (linea != null)
                            {
                                ...
                                if (parte[3].EndsWith(","))
                                {
                                    parte[3] = parte[3].Substring(0, parte[3].Length - 1);
                                }

                                double numero = double.Parse(parte[3]);
